...
try:
    dist = pkg_resources.get_distribution("{{cookiecutter.repo_name}}")
...
man_pages = [
    ('index', 'cookiecutterrepo_name', u'{{cookiecutter.repo_name}} Documentation',
...
texinfo_documents = [
  ('index', 'cookiecutterrepo_name', u'{{cookiecutter.repo_name}} Documentation',
   u'{{cookiecutter.full_name}}', 'cookiecutterrepo_name', 'One line description of project.',
   'Miscellaneous'),
]
